...
[Winker, H., Carvalho, F., Kapur, M. (2018) JABBA: Just Another Bayesian Biomass Assessment. Fisheries Research 204: 275-288.](https://www.sciencedirect.com/science/article/pii/S0165783618300845 "JABBA Reference"){.uri}

fishblicc is a length-based catch-curve model [@medley2025] implemented in an R package [@medley2023].
...
JABBA is not required for this software, but clearly will be needed to generate a fit of the model. See <https://github.com/jabbamodel/JABBA> for installing and using JABBA.
...
2.  Define the linear HCR, ma, change_limit ranges to test and generate one or more HCR within a tibble

3.  Run all HCR to be tested on JABBA fit projections, generating performance indicators for each HCR.
